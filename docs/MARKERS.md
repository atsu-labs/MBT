...
- アイコン: `local_hospital`（Material Icons）
...
- 枠線: 3px 白色
- 影: `0 2px 5px rgba(0,0,0,0.3)`
- アイコン: `local_cafe`（Material Icons）
...
**サイズ:**
- 通常: 20px × 20px（CaseMarkerコンポーネントで定義）
- 選択中: 30px × 30px（強調表示）
